...
const headCells: HeadCell[] = [
  ...
  { id: 'area', numeric: false, disablePadding: true, label: 'Área de atuação' }
]
            ...
            >
              ...
              {orderBy === headCell.id ? (
                <span className={classes.visuallyHidden}>
                  {order === 'desc' ? 'Ordenamento decrescente' : 'Ordenamento crescente'}
                </span>
              ) : null}
            </TableSortLabel>
          </TableCell>
...
export default function Home() {
  ...
  const token = useMemo(() => {
    return 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjhiOWVhY2M4LThkMTAtNGE3OC05ZjlmLTJlYzMzMThhOTQzMyIsImlhdCI6MTYwNjQxMDQ4MSwiZXhwIjoxNjM3OTQ2NDgxfQ.rqp-VTt06mYHcrktzasdgP8-IplyWuOdixeYvMfF3cQ'
  }, [])
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell >{row.area || 'Não informado'}</TableCell>
                    </TableRow>
                  )
                })}
              {emptyRows > 0 && (
